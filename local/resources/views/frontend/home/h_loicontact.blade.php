...
<div class="container p-0">
    <div id="h_contact" class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3 h_contact2 text-center">

                <h4 class="p-2" style="text-transform: uppercase;width: fit-content;margin: auto;font-size: 30px">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="text-align: center">
                        <div class="button-group">
                            <button id="btnSendMail" type="button" class="btn btn-contact bg-primary text-light">GỬI
                                LIÊN HỆ<i
    ...
    font-size: 15px;display: none"></i><i
            ...
            <div class="col-md-6 text-center">
                ...
                {{--</span>--}}
                    <h4 style="margin: auto;color: #007bff;font-size: 22px">LIÊN HỆ NHẬN THÔNG TIN BẤT ĐỘNG SẢN</h4>
                    {{--<span class="lh-span-dash">--}}
                    {{--<span class="line"></span>--}}
                {{--</span>--}}
                </div>
                <div class="empty-space-32"></div>
                <p class="pt-2" style="line-height: 20px">Quí khách vui lòng nhập chính xác thông tin vào form liên hệ
                    bên cạnh để chúng tôi có thể tư vấn tốt nhất.</p>
